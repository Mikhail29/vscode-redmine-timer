...
const translations: Record<string, Record<string, string>> = {
	en: {
		...
		missingRequiredConfiguration:
			'Missing required configuration. Please check the settings of Redmine by DeVylM extension',
	},
	uk: {
		...
		missingRequiredConfiguration:
			"Відсутня обов'язкова конфігурація. Будь ласка, перевірте налаштування розширення Redmine by DeVylM",
	},
	ru: {
		...
		autoStartedDueToEdit:
			'Отслеживание автоматически запущено после изменения файла',
		missingRequiredConfiguration:
			'Отсутствует обязательная конфигурация. Пожалуйста, проверьте настройки расширения Redmine by DeVylM',
	},
	pl: {
		...
		autoStoppedDueToInactivity:
			'Śledzenie zatrzymane z powodu braku aktywności',
		...
		missingRequiredConfiguration:
			'Brak wymaganej konfiguracji. Proszę sprawdzić ustawienia rozszerzenia Redmine by DeVylM',
	},
}
